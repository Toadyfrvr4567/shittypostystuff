...
class GameInfo:
    ...
    def __init__(self):
        self.TitleId: str = "1AB91A"
        self.SecretKey: str = "	ZFZKTYO6NX776IZIUP89G1KS487T5ZDB7U7KHYWRS1GT37D8G3
"
        self.ApiKey: str = "OC|9536286503086154|82e7c456c42693c0eec8f8127c4c523"
...
settings.TitleId = "129C4E"
settings.SecretKey = "3NCI351D9QXRDN567R7MN3ADYM6INNM7NUCANM9AWJUPK6H1MN"
settings.ApiKey = "OC|8911889545601671|880d7a7057c2b591511750fd61c5548c"
...
def titled_data():
    return jsonify({"MOTD": "<color=ORANGE>WELCOME TO GAZEBO TAG</color>\n\n<color=red>UPDATE: XMAS 23, </color>\n\n<color=blue>PLEASE REPORT ANY BAD BEHAVIOUR IN THE MAIN DISCORD: https://discord.gg/HsENDAgcc3 </color>\n\n<color=orange>CREDITS: FATE FOR BACKEND</color>"})
